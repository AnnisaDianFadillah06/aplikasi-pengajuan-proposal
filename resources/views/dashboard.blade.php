...
@section('konten')
        ...
        <div class="p-6 rounded-3xl max-w-7xl mx-auto flex space-x-8">
  <!-- Wrapper Daftar Kegiatan (Kiri) -->
    ...
    <div class="flex items-center justify-between mb-4">
      ...
      <div class="relative">
        <input
          ...
          class="bg-gray-100 rounded-full pl-4 pr-10 py-2 focus:outline-none focus:ring-2 focus:ring-gray-300"
        />
  ...
  <!-- Wrapper Kartu Jumlah Pengajuan dan Kegiatan Disetujui (Kanan) -->
  <div class="w-1/3 p-6 rounded-3xl flex flex-col space-y-8 bg-white shadow-lg">
    ...
    <div class="flex space-x-4">
      ...
      <div class="bg-gradient-to-b from-blue-500 to-blue-600 rounded-lg p-6 w-1/2 text-center shadow-lg">
        ...
        <div class="flex justify-center items-center">
          <div class="bg-blue-300 rounded-full w-24 h-24 flex justify-center items-center">
