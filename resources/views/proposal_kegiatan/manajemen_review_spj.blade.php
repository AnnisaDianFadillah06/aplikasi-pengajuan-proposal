                        ...
                        <table class="table-auto w-full border border-gray-300">
                            <tbody class="divide-y divide-gray-200">
                                ...
                                <tr>
                                    ...
                                    <td class="px-4 py-2">{{ $reviewProposal->nama_penanggung_jawab }}</td>
                                </tr>
                                <tr>
                                    <th class="text-left px-4 py-2 font-medium text-gray-700">Email penanggung jawab</th>
                                    <td class="px-4 py-2">{{ $reviewProposal->email_penanggung_jawab }}</td>
                                </tr>
                                <tr>
                                    <th class="text-left px-4 py-2 font-medium text-gray-700">No hp penanggung jawab</th>
                                    <td class="px-4 py-2">{{ $reviewProposal->no_hp_penanggung_jawab }}</td>
                                </tr>
                                <tr>
