...
<main class="max-w-4xl mx-auto px-4">
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
            ...
            <div class="px-8 py-12 bg-gradient-to-r from-blue-600 to-orange-700 text-center">
                <h3 class="text-3xl font-bold text-white">Form Revisi</h3>
                <p class="mt-2 text-blue-100">Silakan upload revisi Anda</p>
            </div>
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <input type="text" id="nama_penanggung_jawab" name="nama_penanggung_jawab"
                                ...
                                placeholder="Masukan nama penanggung jawab" value="{{ old('nama_penanggung_jawab', $proposal->nama_penanggung_jawab ?? '') }}" />
                        ...
                        <div>
                            ...
                            <input type="email" id="email_penanggung_jawab" name="email_penanggung_jawab"
                                class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200 ease-in-out"
                                placeholder="Masukan email penanggung jawab" value="{{ old('email_penanggung_jawab', $proposal->email_penanggung_jawab ?? '') }}"/>
                        ...
                        <div>
                            ...
                            <input type="text" id="no_hp_penanggung_jawab" name="no_hp_penanggung_jawab"
                                class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200 ease-in-out"
                                placeholder="Masukan nomor HP penanggung jawab" value="{{ old('no_hp_penanggung_jawab', $proposal->no_hp_penanggung_jawab ?? '') }}"/>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" id="nama_kegiatan" name="nama_kegiatan"
                                    class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200 ease-in-out"
                                    placeholder="Masukan nama kegiatan" value="{{ old('nama_kegiatan', $proposal->nama_kegiatan ?? '') }}" />
                            ...
                            <div>
                                ...
                                <input type="text" id="tempat_kegiatan" name="tempat_kegiatan"
                                    class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200 ease-in-out"
                                    placeholder="Masukan tempat kegiatan" value="{{ old('tempat_kegiatan', $proposal->tmpt_kegiatan ?? '') }}" />
                                ...
                                <select id="bidang_kegiatan" name="id_bidang_kegiatan"
                                    ...
                                    @foreach($bidang_kegiatans as $bk)
                                        <option value="{{ $bk->id_bidang_kegiatan }}" 
                                            {{ old('id_bidang_kegiatan', $proposal->id_bidang_kegiatan ?? '') == $bk->id_bidang_kegiatan ? 'selected' : '' }}>
                                ...
                                <select id="jenis_kegiatan" name="id_jenis_kegiatan"
                                    ...
                                    @foreach($jenis_kegiatans as $jk)
                                        <option value="{{ $jk->id_jenis_kegiatan }}" 
                                            {{ old('id_jenis_kegiatan', $proposal->id_jenis_kegiatan ?? '') == $jk->id_jenis_kegiatan ? 'selected' : '' }}>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="date" id="tanggal_mulai" name="tanggal_mulai"
                                    class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200 ease-in-out"
                                    value="{{ old('tanggal_mulai', $proposal->tanggal_mulai ?? '') }}" />
                            ...
                            <div>
                                ...
                                <input type="date" id="tanggal_akhir" name="tanggal_akhir"
                                    class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200 ease-in-out"
                                    value="{{old('tanggal_akhir', $proposal->tanggal_akhir ?? '') }}" />
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="number" id="jml_peserta" name="jml_peserta" step="1" oninput="this.value = this.value.replace(/[^0-9]/g, '')"
                                    class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200 ease-in-out"
                                    placeholder="Masukkan jumlah peserta" value="{{ old('jml_peserta', $proposal->jml_peserta ?? '') }}" />
                            ...
                            <div>
                                ...
                                <input type="number" id="jml_panitia" name="jml_panitia" step="1" oninput="this.value = this.value.replace(/[^0-9]/g, '')"
                                    class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200 ease-in-out"
                                    placeholder="Masukkan jumlah panitia" value="{{ old('jml_panitia', $proposal->jml_panitia ?? '') }}"/>
                        ...
                        <div class="mb-6">
                            ...
                            <div class="relative">
                                ...
                                <input 
                                    ...
                                    value="{{ old('jumlah_spj', $proposal->jumlah_spj ?? '') }}"
                                />
                            </div>
                            <!-- Error Message -->
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div>
                            ...
                            <input type="number" id="dana_dipa" name="dana_dipa" step="1" oninput="this.value = this.value.replace(/[^0-9]/g, '')"
                                class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200 ease-in-out"
                                placeholder="Masukan jumlah dana DIPA" value="{{ old('dana_dipa', $proposal->dana_dipa ?? '') }}" />
                        ...
                        <div>
                            ...
                            <input type="number" id="dana_swadaya" name="dana_swadaya" step="1" oninput="this.value = this.value.replace(/[^0-9]/g, '')"
                                class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200 ease-in-out"
                                placeholder="Masukan jumlah dana swadaya" value="{{ old('dana_swadaya', $proposal->dana_swadaya ?? '') }}"/>
                        ...
                        <div>
                            ...
                            <input type="number" id="dana_sponsor" name="dana_sponsor" step="1" oninput="this.value = this.value.replace(/[^0-9]/g, '')"
                                class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200 ease-in-out"
                                placeholder="Masukan jumlah dana sponsor" value="{{ old('dana_sponsor', $proposal->dana_sponsor ?? '') }}"/>
                ...
                <div class="mb-10">
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <textarea id="pengisi_acara" name="pengisi_acara" rows="3"
                                class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200 ease-in-out"
                                placeholder="Masukan nama pengisi acara">{{ old('pengisi_acara', $proposal->pengisi_acara ?? '') }}</textarea>
                        ...
                        <div>
                            ...
                            <textarea id="sponsorship" name="sponsorship" rows="3"
                                class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200 ease-in-out"
                                placeholder="Masukan nama sponsorship">{{ old('sponsorship', $proposal->sponsorship ?? '') }}</textarea>
                        ...
                        <div>
                            ...
                            <textarea id="media_partner" name="media_partner" rows="3"
                                class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200 ease-in-out"
                                placeholder="Masukan nama media partner">{{ old('media_partner', $proposal->media_partner ?? '') }}</textarea>
                    ...
                    <li class="flex flex-col file-upload-container mb-6" data-input-name="link_surat_izin_ortu">
                        <div>
                            ...
                            <input type="url" id="link_surat_izin_ortu" name="link_surat_izin_ortu"
                                class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200 ease-in-out"
                                placeholder="Masukkan link surat izin orang tua" value="{{ old('link_surat_izin_ortu', $proposal->link_surat_izin_ortu ?? '') }}" />
                    ...
                    <li class="flex flex-col">
                        ...
                        <textarea id="caption_poster" name="caption_poster"
                            ...
                            placeholder="Masukkan caption untuk poster"> {{ old('caption_poster', $proposal->caption_poster ?? '') }}</textarea>
