        ...
        <div class="bg-white rounded-2xl shadow-xl p-8">
            ...
            <div class="text-center mb-8">
                <h3 class="text-3xl font-extrabold bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">
                    Form Revisi Laporan Kegiatan
                </h3>
                <p class="mt-2 text-gray-500">Silakan Upload kembali dokumen yang direvisi</p>
            </div>
            
            <form action="{{ route('spj.uploadFileRevisi', $spj->id_spj) }}" method="post" enctype="multipart/form-data" class="space-y-6" id="revisionSpjForm" onsubmit="return validateAndConfirm(event)">
                @csrf
                ...
                <div class="space-y-2">
                    ...
                    <textarea 
                        ...
                        placeholder="Tulis caption untuk video Anda...">{{ old('caption_video', $spj->caption_video ?? '') }}</textarea>
                    @error('caption_video')
...
<div id="confirmationModal" class="fixed inset-0 bg-gray-900 bg-opacity-50 flex items-center justify-center z-50 hidden">
    <div class="bg-white p-6 rounded-lg shadow-xl max-w-md w-full mx-4">
        <div class="text-center">
            ...
            <h3 class="text-xl font-bold text-gray-900 mb-2">Konfirmasi Revisi SPJ</h3>
            <p class="text-gray-600 mb-6">Apakah Anda yakin ingin mengirimkan revisi SPJ ini? Pastikan semua dokumen yang diupload sudah benar dan sesuai dengan catatan revisi.</p>
...
<script>
    ...
    function validateAndConfirm(event) {
        ...
        const form = document.getElementById('revisionSpjForm');
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        confirmBtn.addEventListener('click', function() {
            modal.classList.add('hidden');
            document.getElementById('revisionSpjForm').submit();
        });
