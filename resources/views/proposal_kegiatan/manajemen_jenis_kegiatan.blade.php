...
<title>@yield('title', 'Jenis Kegiatan')</title> 

<!-- Daftar Jenis Kegiatan Section -->
<div class="flex flex-wrap -mx-3">
  <div class="w-full px-3">
    <h6 class="font-bold">Daftar Jenis Kegiatan</h6> 

    <!-- Button Tambah Jenis Kegiatan di sebelah kanan atas -->
    ...
    <div class="relative w-full max-w-md">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <form id="jenisKegiatanForm" action="{{ route('jenis-kegiatan.store') }}" method="POST" onsubmit="return validateForm()">
                @csrf
                <div class="p-6 space-y-6">
                    <div id="namaKegiatanContainer">
                        ...
                        <p id="namaKegiatanError" class="hidden mt-2 text-sm text-red-600 dark:text-red-500"><span class="font-medium">Oh, snapp!</span> Nama Jenis Kegiatan tidak boleh kosong.</p>
                    </div>
                    <div>
                ...
                <div class="flex items-center justify-end p-6 space-x-2 border-t rounded-b">
