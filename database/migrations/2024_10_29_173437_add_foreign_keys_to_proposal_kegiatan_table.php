...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::connection('pgsql')->table('proposal_kegiatan', function (Blueprint $table) {
            ...
            $table->foreign(['id_bidang_kegiatan'], 'fk_bidang_kegiatan')->references(['id_bidang_kegiatan'])->on('bidang_kegiatan')->onUpdate('no action')->onDelete('cascade'); // Aturan ketika bidang kegiatan dihapus
        });
    }
